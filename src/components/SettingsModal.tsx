    ...
    const TabButton = ({ id, icon: Icon, label }: { id: Tab; icon: any; label: string }) => (
        <button
            ...
            className={clsx(
                ...
                activeTab === id ? "text-[#E0115F]" : "text-zinc-400 hover:text-zinc-200"
            )}
        >
            <Icon size={16} />
            {label}
            {activeTab === id && (
                <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#E0115F] shadow-[0_0_8px_rgba(224,17,95,0.5)]" />
            )}
        </button>
    );
            ...
            >
                ...
                >
                    <h2 className="text-lg font-semibold text-white flex items-center gap-2 pointer-events-none">
                        <SettingsIcon size={20} className="text-[#E0115F]" />
                        Settings
                    </h2>
                            ...
                            <section>
                                ...
                                <div className="bg-zinc-900 rounded-xl p-5 border border-zinc-800">
                                    <div className="flex justify-between items-center mb-4">
                                        ...
                                        <div className="text-xs px-2 py-1 rounded bg-black/30 text-[#E0115F] font-mono border border-amber-500/20">
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        <button
                                            ...
                                            className="w-12 h-12 flex items-center justify-center rounded-xl bg-black/20 hover:bg-amber-500/20 hover:text-[#E0115F] border border-white/10 hover:border-amber-500/50 transition-all active:scale-95"
                                        >
                            ...
                            <section>
                                ...
                                <div className="mb-6">
                                    <div className="flex justify-between mb-2">
                                        ...
                                        <span className="text-sm text-[#E0115F] font-mono">{fontSize}pt</span>
                                    </div>
                                    <input
                                        type="range"
                                        min="12"
                        ...
                        <div className="space-y-6 animate-in slide-in-from-right-4 duration-300 fade-in">
                            <section>
                                ...
                                >
                                    ...
                                    <div className={clsx(
                                        ...
                                        useGermanB ? "bg-[#E0115F]" : "bg-zinc-700"
                                    )}>
                                        <div className={clsx(
                            ...
                            <section>
                                ...
                                >
                                    ...
                                    <div className={clsx(
                                        "w-11 h-6 rounded-full transition-colors relative",
                                        highlightingEnabled ? "bg-[#E0115F]" : "bg-zinc-700"
                                    )}>
                                        <div className={clsx(
                                            "absolute top-1 left-1 bg-white w-4 h-4 rounded-full transition-transform shadow-sm",
