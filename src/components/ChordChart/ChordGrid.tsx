    ...
    return (
        <div className="mb-12">
            <div className="flex items-center">
                <span className="flex h-6 w-7 items-center justify-center bg-zinc-900 font-bold text-[#FF3D00] text-xs border border-zinc-700 mb-[-1px] z-10 rounded-t-sm uppercase tracking-wider tiktok-layer-ruby">
                    {section.label}
                </span>
            </div>
